      ...
      <div className=" w-full h-[400px] flex gap-10 sm:flex-row   font-semibold mt-16  flex-col  sm:gap-0 ">
        ...
        >
          ...
          <div className="flex gap-2 sm:gap-10 ">
            ...
            <div
              onClick={handleCall}
              className="sm:hidden flex items-center  focus:outline-none text-white bg-green-900 hover:bg-green-500 focus:ring-4 focus:ring-green-100 font-medium rounded-lg text-sm px-5 py-2.5  dark:focus:ring-green-600"
            >
