...
import imgs from "./assets/ecommerce.png";
...
function Portfolio() {
  ...
  return (
    <div className="w-full bg-[#F4D35E] overflow-x-hidden">
      ...
      <div
        className="sm:h-[380px] flex mt-10 sm:mt-20 flex-col sm:flex-row gap-2 sm:gap-0 border-2 p-5 mx-8 sm:mx-20 rounded-lg shadow-xl shadow-[red]"
        data-aos="fade-left"
      >
        <div className="w-full sm:w-1/2  flex justify-center items-center flex-col gap-4 p-6">
          ...
          <h1 className="sm:text-3xl  text-2xl uppercase font-bold   text-gray-900">
            E-commerce app
          </h1>
          ...
          <div className="flex gap-6 items-center pt-10 flex-col sm:flex-row sm:gap-10">
            <Link
              to={
                'https://www.linkedin.com/posts/aarij-raza-146364328_excited-to-share-my-new-e-commerce-app-activity-7266579585100664832-nIxy?utm_source=share&utm_medium=member_desktop'
              }
            >
        ...
        <div className="w-full sm:w-1/2    flex justify-center items-center">
          <img
            src={imgs}
            className="sm:h-full sm:w-[36vw] lg:w-[30vw]   object-cover"
          />
        </div>
      </div>
      ...
      >
        <div className="w-full sm:w-1/2  flex justify-center items-center flex-col gap-4 p-6">
          ...
          <h1 className="sm:text-3xl  text-2xl uppercase font-bold text-center  text-gray-900">
            Restaurant Food App
          </h1>
